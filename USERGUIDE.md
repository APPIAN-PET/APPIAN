...
### Run Examples
You can run the following examples to see some of the basic functionalities of APPIAN. Remember to mount your "cimbi" directory by changing </path/to/cimbi/dir> to the actual path to your directory. 

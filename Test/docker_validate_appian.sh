...
docker run -v "$SCRIPTPATH":"/APPIAN" tffunck/appian:latest-dev bash -c "/APPIAN/Test/validate_appian.sh $threads $base_path $test_data_path $out_data_path $exit_on_failure $qc $ts $test_dir"

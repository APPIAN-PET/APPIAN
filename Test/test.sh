...
#zu
docker_path="/opt/APPIAN/Launcher.py"
#docker_path="/data/Launcher.py"
docker run  -v "$SCRIPTPATH":"/data" tffunck/appian:latest bash -c "python $docker_path  -s /data/Test/test_gabriel -t /data/Test/out_test_zu --pvc-fwhm 3 3 3 --sessions zu s002"
